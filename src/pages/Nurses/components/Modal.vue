      ...
      <div class="p-4">
        <div class="flex flex-row justify-between items-center">
          <h2 class="text-xl font-bold">
            {{ isEditMode ? 'Редактировать медсестру' : 'Добавить медсестру' }}
          </h2>
...
const fetchDetails = () => {
  ...
  if (isEditMode.value) {
    Object.assign(formData, props.nurseData);
  } else {
    formData.id = 0;
    formData.fullName = '';
...
const isEditMode = computed(() => !!props.nurseData);
